...
- OPEN: OAuth 2.1 with Dynamic Client Registration is the eventual proper implementation for the Claude clients; the URL token is the pragmatic bridge until then.
